...
url = "http://bustime.mta.info/api/siri/stop-monitoring.json?key=6b1ae742-5ee2-4c8a-89d8-ba25cdc71e88&OperatorRef=MTA&MonitoringRef="+station+"&LineRef=MTA NYCT_B63&MaximumStopVisits=2"
